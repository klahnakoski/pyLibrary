...
def override(func):
    ...
    if not spec.defaults:
        ...
        defaults = {k: v for k, v in zip(reversed(params), reversed(spec.defaults))}
    ...
    def wrapper(*args, **kwargs):
        try:
            if func.__name__ in ("__init__", "__new__") and "kwargs" in kwargs:
            ...
            e = Except.wrap(e)
            if e.message.startswith(func.__name__) and "takes at least" in e:
